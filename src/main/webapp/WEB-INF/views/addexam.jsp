					...
					<div class="row-fluid">
						...
						<div class="span12">
							...
							<form action="addexammark" id="addexammark" class="form-horizontal" method="post">
									...
									<label for="form-field-8"> &nbsp;&nbsp;&nbsp;录入 <b>${exam.classId}</b> 班 <b>${exam.course}</b> 考试成绩 （ 满分<b>${exam.fullMarks}</b> ） </label>
								 	<hr>
								 	<table  class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<input type="hidden" name="examMarks[${sta.index}].classId" value="${student.classId}"></td>
